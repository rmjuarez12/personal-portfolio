  ...
  return (
    <>
      ...
      <div>
        <ProjectBox
          className="mb-6"
          imageUrl="/static/images/procrastin-action.png"
          title="Steam Video Game Deals"
          description={
            <>
              This is a game I had created using the Godot Engine. This specific game was for a game jam{" "}
              <a href="https://itch.io/jam/shovel-jam-2025" target="_blank">
                "Inbound Shovel Jam"
              </a>
            </>
          }
          technologies={["Godot", "GDScript"]}
          codeURL="https://github.com/rmjuarez12/Procrastin-action-Hero-game"
          projectUrl="https://uchiharu.itch.io/procrastin-action-hero"
        />
